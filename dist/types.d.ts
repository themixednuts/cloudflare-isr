...
export type CacheLayerResult = {
    entry: CacheEntry; /** Cache hit — entry is fresh. */
    status: "HIT";
} | {
    entry: CacheEntry; /** Cache stale — entry exists but TTL has passed. */
    status: "STALE";
} | {
    entry: null; /** Cache miss — no entry for this key. */
    status: "MISS";
};
...
export interface HandleRequestOptions<TRequest extends Request = Request, TCtx extends ExecutionContext = ExecutionContext> {
...
export interface LookupOptions<TRequest extends Request = Request, TCtx extends ExecutionContext = ExecutionContext> {
    /** The incoming HTTP request. */
    request: TRequest;
...
export interface CacheResponseOptions<TRequest extends Request = Request, TResponse extends Response = Response, TCtx extends ExecutionContext = ExecutionContext> {
...
export interface CacheBodyOptions<TRequest extends Request = Request, TCtx extends ExecutionContext = ExecutionContext> {
    /** The original request (used to derive the cache key). */
    request: TRequest;
...
export type CacheOptions<TRequest extends Request = Request, TResponse extends Response = Response, TCtx extends ExecutionContext = ExecutionContext> = CacheResponseOptions<TRequest, TResponse, TCtx> | CacheBodyOptions<TRequest, TCtx>;
...
export interface ISRInstance {
   ...
   * @param options - `{ request, ctx, routeConfig }`.
     ...
     */
    handleRequest<TRequest extends Request = Request, TCtx extends ExecutionContext = ExecutionContext>(options: HandleRequestOptions<TRequest, TCtx>): Promise<Response | null>;
    /**
   ...
   * @param options - `{ request, ctx }`.
     ...
     */
    lookup<TRequest extends Request = Request, TCtx extends ExecutionContext = ExecutionContext>(options: LookupOptions<TRequest, TCtx>): Promise<Response | null>;
    /**
   ...
   * @param options - `{ request, response, routeConfig, ctx }`.
     ...
     */
    cache<TRequest extends Request = Request, TResponse extends Response = Response, TCtx extends ExecutionContext = ExecutionContext>(options: CacheOptions<TRequest, TResponse, TCtx>): Promise<Response>;
    /**
